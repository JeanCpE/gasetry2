...
def detection(image_file, text):
    ...
    if 'classes' not in [action.dest for action in detect.parser._actions]:
        detect.parser.add_argument('--classes', nargs='+', type=int, help='filter by class: --class 0, or --class 0 2 3')
